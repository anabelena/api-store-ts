...
//Funcion Asincrona el tipado debe retornar una PROMISE 
//y lo que esta dentro de la promesa es lo que se va a devolver
// _req el guion bajo indica que esa variable no se usa en la funcion o solo _
export async function list(_req: Request, res: Response): Promise<Response> {
  ...
  export async function update(req: Request, res: Response): Promise<Response> {
    try {
        //valida si existe password en el body
